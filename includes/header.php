...
if(!in_array($page, array('home','cat-breeding','gallery','contact','quote','quote_send','contact_send','submit')))
...
<body>
    ...
    <div class="container-fluid">
        <div class="container">
        <div class="row">
        <div class="col-md-6 lnedia" >
            Welcome to Little Bell Cattery
        </div>
        <div class="col-md-6 lnedia" style="text-align: right;"><a href="https://www.facebook.com/groups/2160432137619208/?tn-str=*F" target="_blank"><i class="fa fa-facebook-f" ></i></a>
        ...
        <div class="header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9" style="text-align: right; margin-top: 20px;">
                        <a href="tel:02 4464 2223" style="text-decoration:none;">
                            ...
                            <nav id="menu">
                                ...
                                <ul class="main-menu clearfix">
                                    ...
                                    <li class="<?php if($page=='cat-breeding'){echo 'active';} ?>"><a href='./cat-breeding'>Cat Breeding</a></li>
